...
# @IDE     : PyCharm
# @FileName: config_CPPIF_transformer.py
...
def get_train_config():
	...
	# model parameters
	parse.add_argument('-max-len', type=int, default=800, help='max length of input sequences')
	parse.add_argument('-num-layer', type=int, default=1, help='number of encoder blocks')
	parse.add_argument('-num-head', type=int, default=9, help='number of head in multi-head attention')
	parse.add_argument('-dim-embedding', type=int, default=64, help='residue embedding dimension')
	parse.add_argument('-dim-feedforward', type=int, default=512, help='hidden layer dimension in feedforward layer')
	...
	parse.add_argument('-accum-steps', type=int, default=8, help='Gradient Accumulation')
