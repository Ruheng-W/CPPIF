# -*- coding: utf-8 -*-
# @Time    : 2022/4/19 16:56
# @Author  : WANG Ruheng
# @Email   : blwangheng@163.com
# @IDE     : PyCharm
# @FileName: config_CPPIF.py
...
def get_train_config():
	...
	parse.add_argument('-accum-steps', type=int, default=32, help='Gradient Accumulation')
	...
	parse.add_argument('-interval-log', type=int, default=2048,
